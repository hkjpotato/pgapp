...
export default class ZoomBrushBase extends React.PureComponent {
  ...
  onClick(e) {
    //https://www.npmjs.com/package/react-native-listener
    if (!this.state.zoomable) {
      //to notify the parent that a click event on white space happen during brush mode
      e.preventDefault();
    }
    //for zoomable, we dont preventDefault because we want to allow click on parent svg do the clean function
  }
  render() {
  ...
  //   //wrapper component for arbitray children should not do checking here
  //   //https://discuss.reactjs.org/t/shouldcomponentupdate-and-children/2055/12
  //   //https://github.com/facebook/react/issues/6515
  //   return true;
  // }