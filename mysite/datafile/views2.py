...
def project_detail(request, projectName):
    ...
    for feeder in feeders:
        ...
        try:
            ...
            #     "table": reverse('pgnetwork:tableview', kwargs={'projectName': projectName, 'feederName': feeder['feederName']}),
            #     "graph": reverse('pgnetwork:forcevis', kwargs={'projectName': projectName, 'feederName': feeder['feederName']})
            # }
            # else:
